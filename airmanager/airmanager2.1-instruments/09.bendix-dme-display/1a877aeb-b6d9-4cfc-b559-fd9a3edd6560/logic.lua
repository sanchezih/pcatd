-- Global variables --
local persist_power = persist_add("power", "INT", 2)
local gbl_power  = 0
local gbl_dist1  = 0
local gbl_speed1 = 0
local gbl_dist2  = 0
...
txt_naut = txt_add(" ", "-fx-font-size:40px; -fx-fill: #fb2c00; -fx-text-alignment: RIGHT;", 15, 35, 150, 150)
txt_nm = txt_add("NM", "-fx-font-size:20px; -fx-font-family:\"GOST Common\"; -fx-fill: #fb2c00; -fx-text-alignment: LEFT;", 175, 52, 50, 50)
txt_nav1 = txt_add("1", "-fx-font-size:22px; -fx-font-family:\"GOST Common\"; -fx-fill: #fb2c00; -fx-text-alignment: LEFT;", 205, 52, 50, 50)
txt_nav2 = txt_add("2", "-fx-font-size:22px; -fx-font-family:\"GOST Common\"; -fx-fill: #fb2c00; -fx-text-alignment: LEFT;",205, 32, 50, 50)

txt_knots = txt_add(" ", "-fx-font-size:40px; -fx-fill: #fb2c00; -fx-text-alignment: RIGHT;", 180, 35, 150, 150)
txt_kt = txt_add("KT", "-fx-font-size:20px; -fx-font-family:\"GOST Common\"; -fx-fill: #fb2c00; -fx-text-alignment: LEFT;", 340, 52, 50, 50)

txt_mn = txt_add(" ", "-fx-font-size:40px; -fx-fill: #fb2c00; -fx-text-alignment: RIGHT;", 330, 35, 150, 150)
txt_min = txt_add("MIN", "-fx-font-size:20px; -fx-font-family:\"GOST Common\"; -fx-fill: #fb2c00; -fx-text-alignment: LEFT;", 490, 52, 50, 50)
...
function update_gui()
    ...
    elseif distance < 10 and distance > 0 then
        txt_set(txt_naut, "0" .. var_format(distance, 1) )
	else
		txt_set(txt_naut, "00.0" )
    end
...
-- Switch add --
switch_state = switch_add( "knob_dn.png","knob_up.png","knob_off.png",582 ,31,64,64, new_state )

switch_set_state(switch_state, 2)
persist_put(persist_power, 2)
